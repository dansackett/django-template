...
def setup_database():
    ...
    call("sed 's/DATABASE_PASSWORD/{}/g;s/_SECRET_KEY/{{ secret_key }}/g' {{ project_name }}/settings/temp_local.py > {{ project_name }}/settings/local.py".format(local_db_pwd), shell=True)
